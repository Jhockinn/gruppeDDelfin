...
public class Chairman {
    ...
    public void addNewMember(ArrayList<Members> list) {
        ...
        if (!memberExists) {
            ...
            newMember.restan(returnMemberPrice());
            unactive(newMember);
    ...
    // used in AddMember, gives a price based on age to calculate restance.
    public int returnMemberPrice() {
        if (age < 18) {
            return 1000;
        }
        if (age > 18 && age < 60) {
    ...
    public void unactive(Members member) {
